...
== Changelog ==
= 1.2.2 =
* 워드프레스 4.4버전과의 호환성 확인
* 모바일 하단의 "무빙카트 위젯" 표시여부 옵션 추가. 모바일에서의 "무빙카트 위젯"은 반응형으로 제작되지 않은 모바일 웹페이지에서 쉽게 판매 상품을 리스팅해보기 위한 기능으로, 반응형으로 웹사이트가 제작된 경우(모바일에서 디스플레이가 문제없는 경우)에는 "위젯"을 숨기셔도 무방합니다.
